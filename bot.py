...
async def on_message(message):
	...
	if msg in vk_words:
		emb = discord.Embed(title = 'Кликай сюда чтобы перейти!', description = 'Это вк владельца сервера, переходи для связи с ним!', colour = discord.Color.green(), url = 'https://vk.com/max_1_grozniy')
